...
#include "Interface/EnemyDamageInterface.h"
...
void ATestPlayer::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (EnhancedInputComponent) {
		...
		EnhancedInputComponent->BindAction(RunAction, ETriggerEvent::Triggered, this, &ATestPlayer::ToggleRun);
	}
}
...
void ATestPlayer::InputFire(const FInputActionValue& Value)
{
	...
	if (bEnemyHit)
	{
		...
		IEnemyDamageInterface* EnemyDamageInterface = Cast<IEnemyDamageInterface>(HitInfo.GetActor());
		if(EnemyDamageInterface)
			EnemyDamageInterface->OnDamageProcess();
	}
...
void ATestPlayer::ToggleRun(const FInputActionValue& Value)
{
